    ...
    <header className="sticky top-0 z-30 bg-base-bg border-b-3 border-base-ink">
      <div className="flex items-center justify-between px-6 h-16">
        ...
        <button
          ...
          className="font-display font-bold text-sm rounded-brutal border-3 border-base-ink bg-accent-lime px-5 py-2.5 shadow-brutal hover:shadow-brutal-lg active:shadow-brutal-pressed transition-shadow"
        >
          + Transaksi
        </button>
      </div>
